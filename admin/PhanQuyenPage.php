...
<section id="main-content">
    <section class="wrapper">
        <div class="market-updates">
            <h3 class="mb-4"><a href="PhanQuyenPage.php" style="color:black;">Quyền</a> / Cấp quyền</h3>
        </div>
        <!-- Menu ngang -->
            ...
            <div id="contentArea">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                echo "<tr><td colspan='8'>Không có thành viên</td></tr>";
                            }
                            ?>
                        </tbody>
                    </table>
                ...
                <div class="row">
                    <div class="col-12 text-center pagination">
                        <?php
                        // Tính tổng số trang
                        $totalPages = ceil(count($ds) / $recordsPerPage);

                        // Hiển thị nút "prev" nếu không phải trang đầu tiên
                        if ($page > 1) {
                            echo "<a href='PhanQuyenPage.php?page=" . ($page - 1) . "' class='btn btn-primary'>Prev</a>";
                        }

                        // Hiển thị các trang
                        for ($i = 1; $i <= $totalPages; $i++) {
                            $activeClass = ($i == $page) ? 'active' : '';
                            echo "<a href='PhanQuyenPage.php?page=$i' class='btn btn-primary $activeClass'>$i</a>";
                        }

                        // Hiển thị nút "next" nếu không phải trang cuối cùng
                        if ($page < $totalPages) {
                            echo "<a href='PhanQuyenPage.php?page=" . ($page + 1) . "' class='btn btn-primary'>Next</a>";
                        }
                        ?>
                    </div>
                </div>
