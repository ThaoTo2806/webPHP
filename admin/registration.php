...
<div class="w3layouts-main">
    ...
    <form action="#" method="post">
        <input type="text" class="ggg" name="Name" placeholder="HỌ VÀ TÊN" required="">
        <input type="text" class="ggg" name="Account" placeholder="TÀI KHOẢN" required="">
        <input type="email" class="ggg" name="Email" placeholder="E-MAIL" required="">
        <input type="text" class="ggg" name="Phone" placeholder="SỐ ĐIỆN THOẠI" required="">
        <input type="password" class="ggg" name="Password" placeholder="MẬT KHẨU" required="">
        <input type="password" class="ggg" name="ConfirmPass" placeholder="XÁC NHẬN LẠI MẬT KHẨU" required="">
        ...
        <h4><input type="checkbox" />Tôi đồng ý với các điều khoản chính sách</h4>
...
<script>
    ...
    // Tự động tạo mã khi trang web hiển thị
